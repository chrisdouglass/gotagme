  ...
  static fromFlickrAPIPhoto(APIPhoto) {
    ...
    */
    photo.small_image_url = 
        "http://farm" + APIPhoto.farm + ".staticflickr.com/" + APIPhoto.server + "/" + APIPhoto.id 
            + "_" + APIPhoto.secret + ".jpg";
    photo.medium_image_url = 
        "http://farm" + APIPhoto.farm + ".staticflickr.com/" + APIPhoto.server + "/" + APIPhoto.id 
            + "_" + APIPhoto.secret + "_c.jpg";
    photo.large_image_url = 
        "http://farm" + APIPhoto.farm + ".staticflickr.com/" + APIPhoto.server + "/" + APIPhoto.id 
            + "_" + APIPhoto.secret + "_b.jpg";
    photo.xlarge_image_url = 
        "http://farm" + APIPhoto.farm + ".staticflickr.com/" + APIPhoto.server + "/" + APIPhoto.id 
            + "_" + APIPhoto.secret + "_h.jpg";
    // TODO: Figure out how to get k (which the actual page has...)
    /*
    photo.flickr_xxlarge_image_url = 
        "http://c" + APIPhoto.farm + ".staticflickr.com/" + APIPhoto.farm + "/" + APIPhoto.server + 
        "/" + APIPhoto.id + "_" + APIPhoto.secret + "_k.jpg";
    */
    ...
    if (APIPhoto.originalsecret) {
      photo.orig_image_url = 
          "http://farm" + APIPhoto.farm + ".staticflickr.com/" + APIPhoto.server + "/" 
              + APIPhoto.id + "_" + APIPhoto.originalsecret + "_o.jpg";
    }
