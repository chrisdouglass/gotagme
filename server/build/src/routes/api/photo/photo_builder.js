...
var FlickrPhotoBuilder = require('../flickr/flickr_photo_builder.js');
/** Builds Photos. */
var PhotoBuilder = /** @class */ (function () {
    /**
     * @constructor
     ...
     */
    function PhotoBuilder(flickrPhotoResponse, postedByUser) {
     ...
     */
    PhotoBuilder.prototype.build = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                flickrBuilder = new FlickrPhotoBuilder(this.flickrPhoto);
                return [2 /*return*/, flickrBuilder.build().then(function (flickrPhoto) {
                        return flickrPhoto.save();
                    }).then(function (flickrPhoto) {
                        var photo = new Photo();
                        photo.postedBy = _this.postedByUser._id;
    ...
    PhotoBuilder.prototype.verify_ = function () {
